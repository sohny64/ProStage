 ...
 */
final class Version20210111200427 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stage (id INT AUTO_INCREMENT NOT NULL, intitule VARCHAR(150) NOT NULL, descriptif VARCHAR(1000) DEFAULT NULL, date_debut DATE DEFAULT NULL, duree VARCHAR(15) DEFAULT NULL, competences_requises VARCHAR(500) DEFAULT NULL, experience_requise VARCHAR(100) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
