 ...
 */
final class Version20210112181956 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stage ADD entreprise_id INT NOT NULL, CHANGE intitule titre VARCHAR(150) NOT NULL');
  ...
  */  }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE stage DROP entreprise_id, CHANGE titre intitule VARCHAR(150) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
